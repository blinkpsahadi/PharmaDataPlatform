...
                    
                    # Limite aux 10 premières catégories pour les graphiques à barres trop longs
                    if len(count_df) > 10:
...
        # Classes Thérapeutiques (Pie Chart) 
...
            # 2.3. Box Plot de Prix par Classe Thérapeutique
